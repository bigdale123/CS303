...
addresult = str(linearSearch(array1, 1)) + str(linearSearch(array1, 0)) + str(linearSearch(array1, 1000)) + str(linearSearch(array1, 10001)) + str(linearSearch(array1, 9999)) + str(linearSearch(array1, 99999)) + 	    str(linearSearch(array2, 1)) + str(linearSearch(array2, 0)) + str(linearSearch(array2, 1000)) + str(linearSearch(array2, 10001)) + str(linearSearch(array2, 9999)) + str(linearSearch(array2, 99999)) +	    str(linearSearch(None, 1)) + str(linearSearch(None, 0)) + str(linearSearch(array2, 1000000)) + str(linearSearch(array2, 999998)) + str(linearSearch(array1, 1000000)) + str(linearSearch(array1, 99999))
