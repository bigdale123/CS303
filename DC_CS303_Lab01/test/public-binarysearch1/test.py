...
addresult = str(binarySearch(array1, 1)) + str(binarySearch(array1, 0)) + str(binarySearch(array1, 1000)) + str(binarySearch(array1, 10001)) + str(binarySearch(array1, 9999)) + str(binarySearch(array1, 99999)) + 	    str(binarySearch(array2, 1)) + str(binarySearch(array2, 0)) + str(binarySearch(array2, 1000)) + str(binarySearch(array2, 10001)) + str(binarySearch(array2, 9999)) + str(binarySearch(array2, 99999)) +	    str(binarySearch(None, 1)) + str(binarySearch(None, 0)) + str(binarySearch(array2, 1000000)) + str(binarySearch(array2, 999998)) + str(binarySearch(array1, 1000000)) + str(binarySearch(array1, 99999))
